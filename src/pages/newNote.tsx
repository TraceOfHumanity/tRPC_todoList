...
const Newnote: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="mx-auto flex min-h-screen flex-col justify-center px-2 py-10 md:container bg-gradient-to-b from-[#2e026d] to-[#15162c]">
        <Link
        ...
        >
          <input
            ...
            required
            value={data.title}
            placeholder="Your title (min 3 characters)"
          ...
          <textarea
            ...
            placeholder="Your description (max 200 characters)"
